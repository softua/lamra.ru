...
if(this.$element.parent().parent().attr('id')=='accordion'){this.$element.prev().css('background-color','#e6263b')
this.$trigger.css('color','#fff').children('span').css('color','#fff')}else if(this.$element.parent().parent().attr('id')=='accordion2'){this.$trigger.css('color','#e6263b').children('span').css('color','#e6263b')}this.transitioning=1
...
if(this.$element.parent().parent().attr('id')=='accordion'){this.$element.prev().css('background-color','#efefef')
this.$trigger.css('color','#000').children('span').css('color','#848484')}else if(this.$element.parent().parent().attr('id')=='accordion2'){this.$trigger.css('color','#000').children('span').css('color','#000')}var complete=function(){this.transitioning=0
